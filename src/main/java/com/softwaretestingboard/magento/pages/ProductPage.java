...
public class ProductPage extends Utility {
    ...
    public void verifySortingOfProductsInAscendingOrder(String option){
        ...
        verifySortingOfPriceInAscendingOrder(jacketElementList,sortByField, option);
    }


    public void verifySortingOfPriceInAscendingOrder(By jacketElementList, By sortByField, String option){
        waitUntilVisibilityOfElementLocated(jacketsPriceElementList,5);
        verifySortingOfPriceInAscendingOrder(jacketsPriceElementList, this.sortByField,option);
    }
